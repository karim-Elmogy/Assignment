					...
					<div class="main-header-right">
						...
						<div class="nav nav-item  navbar-nav-right ml-auto">
							...
							<div class="dropdown main-profile-menu nav nav-item nav-link">
                                ...
                                <a class='profile-user d-flex' href=''><img  src={{URL::asset('assets/img/faces/user.png')}}></a>
								...
								<div class="dropdown-menu">
									<div class="main-header-profile bg-primary p-3">
										<div class="d-flex wd-100p">
											...
											<div class="main-img-user">
                                                <img  src={{URL::asset('assets/img/faces/user.png')}} >


                                            </div>
											<div class="mr-3 my-auto">
                                                @if(auth('service')->check())
                                                    <h6>{{Auth::guard('service')->user()->name}}</h6>
                                                    <span>{{Auth::guard('service')->user()->email}}</span>
									...
									<a class="dropdown-item" href=""><i class="bx bx-user-circle"></i> Edit Profile</a>
                                    ...
                                    @else
                                        <form method="GET" action="{{route('logout','service')}}">
                                    @endif
                                    @csrf
